...
describe("utility functions", () => {
   describe("extractPositions", () => {
      it("should correctly extract a position array from a normal RedisFlightRecord", function() {
      ...
      it("should correctly extract a position array from a single item RedisFlightRecord", function() {
      ...
      it("should correctly extract a position array from an insufficiently sized RedisFlightRecord", function() {
